					...
					<div id='result3'>선택안함</div>
						...
						<figure>
							...
							<button class="btn" value="friend" id="btn" type="submit"
								name="choice" onclick='hidden_change("친선")'><input type="hidden" name="choice" value="선택안함" class="result" id="hidden_input">
						...
						<figure>
							...
							<button class="btn" value="rank" id="btn" type="submit"
								name="choice" onclick='hidden_change("랭크")'><input type="hidden" name="choice" value="선택안함" class="result" id="hidden_input">
								<img class="btn-img" src="/99.img/랭크경기.jpg">
							</button>
