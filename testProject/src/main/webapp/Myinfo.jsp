...
<body>
	...
	<div class="Card">
		...
		<div class="My_info1">
			<ul>
				<li>이름<bR> <span><%=vo.getMEMBER_NAME()%></span>
				</li>
				<li>성별<bR> <span><%=vo.getGENDER()%></span>
				</li>
				<li>휴대전화<bR> <span><%=vo.getMEMBER_PHONE()%></span>
				</li>
		...
		<div class="My_info2">
			...
			<div class="barOuter">
				...
				<div class="barLevel barHTML">
					선호지역 <i class="fas fa-search-location"></i>
					<p class="My_type"><%=vo.getP_AREA()%></p>
				</div>

				<div class="barLevel barHTML">
					포지션 <i class="fas fa-futbol"></i>
					<p class="My_type"><%=vo.getPOSITION()%></p>
				</div>

				<div class="barLevel barHTML">
					소속 팀 <i class="fas fa-users"></i>
			...
			<div class="barOuter2">
				...
				<div class="barLevel barHTML">
					경기일자
					<p class="My_type">
						<i class="far fa-calendar-alt"></i><%=Bvo.getMATCHING_DATE()%></p>
				</div>

				<div class="barLevel barHTML">
					경기지역
					<p class="My_type">
						<i class="far fa-calendar-alt"></i><%=Bvo.getADDRESS()%></p>
				</div>

				<div class="barLevel barHTML">
					경기장
					<p class="My_type">
						<i class="far fa-calendar-alt"></i><%=Bvo.getFILED_NAME()%></p>
				</div>

				<div class="barLevel barHTML">
					게임방식
					<p class="My_type">
						<i class="far fa-calendar-alt"></i><%=Bvo.getGAMES()%></p>
				</div>

				<div class="barLevel barHTML">
					경기시간
					<p class="My_type">
						<i class="far fa-calendar-alt"></i><%=Bvo.getTIMES()%></p>
				</div>
			...
			<div>상대팀 평가 <form action="MannerForm.jsp"><input type="submit" class="form" value="상대팀 평가"></form>
			 </div>
