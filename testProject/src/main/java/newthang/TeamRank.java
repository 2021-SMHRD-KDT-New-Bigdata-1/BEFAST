...
//		out.println("</tr>");
		...
		out.println("<th class=text-center width=25%>순위</th>");
		out.println("<th class=text-center width=25%>팀명</th>");
		out.println("<th class=text-center width=25%>매너점수</th>");
		out.println("<th class=text-center width=25%>전적/승점</th>");
		out.println("</tr>");
		// 출력
